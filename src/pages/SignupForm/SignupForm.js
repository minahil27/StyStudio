...
import back from "../../assets/Rectangle 10.png";
import PreviewImage from "../../components/SignupForm/PreviewImage";
          ...
          >
            {({ errors, touched }) => (
              <Form>
                ...
                <div style={{ display: "flex" }} className='img-desp-container'>
                  <div>
                    <Field
                      id="image"
                      name="image"
